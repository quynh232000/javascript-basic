...
const renderListProduct = (listProduct) => {
  const html = listProduct.map((item, index) => {
    ...
    let htmlSelec = arr.map((p) => {
      return `
      <option value="Size 8:12 -15kg" ${p == item.size && "selected"}>p</option>
      `;
    });
    ...
    return `
                    <div class="b-group-body b-group-body-product" data-index=${index}>
                        <div class="b-g-item">
                            ...
                            <div class="item-end">
                            <select class="item-end-text" value = "${
                              item.size
                            }">
                            <option value="Size 8:12 -15kg">Size 8:12 -15kg</option>
                            <option value="Size 12:16 -18kg">Size 12:16 -18kg</option>
                            <option value="Size 16:22 -35kg">Size 16:22 -35kg</option>
                          </select>
                            </div>
                        </div>
                        <div class="b-g-item">
