    ...
    if (isInvalid) {
      if (setIsLogin) {
        ...
        if (info) {
          if (info.email === data.email) {
            if (info.password === data.password) {
              ...
              setTimeout(() => {
                ...
                store.dispatch(actions.actionUserInfo(data1.data));
                window.location.href = "/ASM";
              }, 3000);
            } else {
              msgFail.textContent = "Nhập sai password! Vui lòng nhập lại.";
            }
          } else {
            msgFail.textContent = "Email không đúng! Vui lòng nhập lại.";
          }
          ...
          postData("https://store.mr-quynh.com/login-user", data).then(
            (data1) => {
              console.log(data1);
              if (data1.errCode == 0) {
                loadingEl.classList.remove("hidden");
                ...
                msgFail.textContent = data1.errMessage;
              }
            }
          );
        }
