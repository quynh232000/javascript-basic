...
const bodyFormEl = document.querySelector(".body-form");
...
>
  ...
  <button class="form-submit login-form">Đăng nhập</button>
  ...
  bodyFormElement.innerHTML = ` <form
  action="/ASM/index.html"
  method="GET"
...
>
  ...
  <div class="form-submit register-form">Đăng kí</div>
  <div class="has-account">
